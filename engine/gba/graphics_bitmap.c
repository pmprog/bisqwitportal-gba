...
IWRAM_CODE void graphics_bitmap_setpixel(s16 X, s16 Y, u8 PaletteIndex )
{
...
IWRAM_CODE void graphics_bitmap_line_horizontal(s16 X1, s16 Y, s16 X2, u8 PaletteIndex )
{
...
IWRAM_CODE void graphics_bitmap_line(s16 X1, s16 Y1, s16 X2, s16 Y2, u8 PaletteIndex )
{
    if(Y1 == Y2)
    {
