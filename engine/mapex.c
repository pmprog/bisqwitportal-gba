...
void mapex_scrollviewport(u8 Plane, s32 DeltaX, s32 DeltaY)
{
    ...
    planemaps[Plane].ViewX = newx;
    planemaps[Plane].ViewY = newy;
    ...
    if (DeltaX != 0)
    {
        ...
        if (DeltaX < 0)
        {
            ...
            while(col_current != col_target)
            {
                ...
                mapex_reversetile(Plane, &col_map, &col_mapsub, planemaps[Plane].MapWidth);
        ...
        else
        {
            ...
            while(col_current != col_target)
            {
                ...
                mapex_advancetile(Plane, &col_map, &col_mapsub, planemaps[Plane].MapWidth);
                mapex_fillcol(Plane, col_current, col_map, col_mapsub);
            }
        }
